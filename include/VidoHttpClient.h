...
#ifndef VidoHttpClient_h
#define VidoHttpClient_h
...
class VidoHttpClient : public VidoGsmClientSim800
{
public:
...
// FIXME Update tempToPachube example to calculate Content-Length correctly
    ...
    VidoHttpClient(VidoGsmClientSim800& aClient, const char* aServerName, uint16_t aServerPort = kHttpPort);
    VidoHttpClient(VidoGsmClientSim800& aClient, const String& aServerName, uint16_t aServerPort = kHttpPort);
    VidoHttpClient(VidoGsmClientSim800& aClient, const IPAddress& aServerAddress, uint16_t aServerPort = kHttpPort);
